...
### [`@shanewas/form-validation`](https://www.npmjs.com/package/@shanewas/form-validation)
Enterprise-ready form validation engine for Node.js and browsers. Rule-based, dependency-driven, async-capable, with EN/JP i18n support.
`JavaScript` `Node.js` `NPM`

### [`PayFlow`](https://github.com/shanewas/payflow)
Full-stack payment processing system — Stripe API, JWT auth, webhook verification, Swagger docs, Dockerized CI/CD.
`Node.js` `PostgreSQL` `React` `Docker`

### `AIW Core` *(Ferntech, private)*
Hyper-automation platform for banking sector. Desktop + web automation studio with shared engine, ML pipelines, and workflow orchestration.
`Python` `MongoDB` `ElectronJS` `Docker`

---

## 📄 Research

- **[Alzheimer's Disease Prediction Using CNNs on OCT Images](https://ieeexplore.ieee.org/document/9306649)** — IEEE, 2019. Transfer learning with VGG19 and Inception v3. Joint research with University of Sydney.
